    ...
    <div class="md:flex flex-col items-start justify-center bg-gray-100 p-4 px-10">
        <div class="w-full mx-auto px-2 mb-4">
            <div class="flex items-center space-x-2 text-gray-400 text-sm">
                ...
                <a href="/store/transport"
                    class="hover:underline hover:text-gray-600 hover:scale-110 transition duration-300">Transportes</a>
                <span>
                    <svg class="h-5 w-5 leading-none text-gray-300" xmlns="http://www.w3.org/2000/svg" fill="none"
                        viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
        ...
        <div class="md:flex items-start justify-center py-12 2xl:px-20 md:px-6 px-4 bg-white  shadow-lg rounded-xl">
            ...
            <div class=" w-full ml-6">
                ...
                <div class="py-4 border-b border-gray-200 flex items-center justify-between">
                    <p class="text-base leading-4">Tipo</p>
                    <div class="flex items-center justify-center">
                ...
                <div class="py-4 border-b border-gray-200 flex items-center justify-between">
                    <p class="text-base leading-4">Ciudades</p>
                    <div class="flex items-end justify-center flex-col">
                        {{-- <p class="text-sm leading-none">{{ $prod->city_id }}</p> --}}
                        <p class="text-sm leading-none">
                            <span class="font-semibold">Salida:</span> {{ $extra->name }}, {{ $extra->country->name }}
                        </p>
                        <p class="text-sm leading-none mt-2">
                            <span class="font-semibold">Destino:</span> {{ $extra2->name }}, {{ $extra2->country->name }}
                        </p>
                    </div>
                </div>
